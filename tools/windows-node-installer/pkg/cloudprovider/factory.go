...
func CloudProviderFactory(kubeconfigPath, credentialPath, credentialAccountID, resourceTrackerDir, imageID, instanceType, sshKey string) (Cloud, error) {
	...
	case v1.AWSPlatformType:
		return aws.New(imageID, instanceType, sshKey, oc, credentialPath, credentialAccountID, resourceTrackerFilePath)
	default:
